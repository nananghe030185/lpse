{{-- {{ $applpse = App\AppLpse::class }} --}}
{{-- {{ $harga_personal = App\AppLpse::setting('harga_personal') }} --}}
{{-- {{ $harga_corporate = App\AppLpse::setting('harga_corporate') }} --}}
{{ $harga_special = App\AppLpse::setting('harga_special') }}
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="nominal" id="nominal"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option value="{{ $hargapersonal }}">
                                Rp. {{ Number::format($hargapersonal, 0, 0, 'id-ID') }} -
                                {{-- {{ $applpse::usergroup(3) }} --}}
                            </option>
                            <option value="{{ $hargacorporate }}">
                                Rp. {{ Number::format($hargacorporate, 0, 0, 'id-ID') }} -
                                {{-- {{ $applpse::usergroup(4) }} --}}
                            </option>
                            <option value="{{ $harga_special }}">
                                Rp. {{ Number::format($harga_special, 0, 0, 'id-ID') }} -
                                {{-- {{ $applpse::usergroup(5) }} --}}
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300 font-thin" id="file_input_help">
