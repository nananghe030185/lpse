    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="/" class="flex items-center justify-between mr-4">
                ...
                @else
                    <img src="{{ asset($slot) }}" alt="LPSE Indonesia" class="mr-3 h-8" />
                @endif

                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
                    {{ Str::replace('_', ' ', config('app.name')) }}</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        ...
                        <a href="{{ route('usergroup.index') }}"
                            ...
                            <div class="text-sm text-gray-900 dark:text-white">User Group</div>
                        </a>
                        ...
                        <a href="{{ route('konfirmasi.index') }}"
                            ...
                            <div class="text-sm text-gray-900 dark:text-white">Konfirmasi Pembayaran</div>
                        </a>
                        ...
                        <a href="#" data-modal-target="createPesanModal" data-modal-toggle="createPesanModal"
                            class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                            <svg class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="text-sm text-gray-900 dark:text-white">Pesan</div>
                        </a>
            ...
            <button type="button"
                ...
                {{-- @if (auth()->user()->profile->image)
                    <img class="w-8 h-8 rounded-full" src="{{ asset('storage/' . auth()->user()->profile->image) }}"
                        alt="{{ auth()->user()->name }}" />
                @else
                ...
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <button type="submit" name="submit"
                                class="block py-2 px-4 text-sm hover:bg-gray-100 hover:border-2 dark:hover:bg-gray-600 dark:hover:text-white">
                                Logout
                            </button>
                        </form>
                    </li>
...
<!-- Create modal -->
<div id="createPesanModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    {{ __('global.kirimpesan') }}
                </h3>
                <button type="button"
                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    data-modal-target="createPesanModal" data-modal-toggle="createPesanModal">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select name="group_id" id="group"
                            ...
                            @foreach (App\Models\UserGroup::get() as $group)
