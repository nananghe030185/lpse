<x-backend.layout>
    ...
    <x-slot name="header">
        <x-breadcrumb href="{{ route('konfirmasi.index') }}">Konfirmasi</x-breadcrumb>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="{{ route('konfirmasi.index') }}" method="post">
                            @csrf
                            @method('get')
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $data->pemilik }}</td>
                                    <td class="px-4 py-3">Rp. {{ Number::format($data->nominal, 0, 0, 'id-ID') }}</td>
                                    <td class="px-4 py-3">
                                        {{ Carbon\Carbon::parse($data->tanggal)->format('d M Y') }}
                                    </td>
                                    <td class="px-4 py-3"><a href="{{ asset('storage/' . $data->bukti_transfer) }}"
                                            target="_blank">Klik Disini</a></td>
                                    <td class="px-4 py-3">{{ $data->catatan }}</td>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="apple-imac-{{ $data->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="readKonfirmasiModal{{ $data->id }}"
                                                        data-modal-toggle="readKonfirmasiModal{{ $data->id }}"
                                                ...
                                                @if (!$data->status)
                                                    <li>
                                                        <form action="/admin/konfirmasi/{{ $data->id }}"
                                                            method="post">
                                                            @csrf
                                                            @method('put')
                                ...
                                <div id="deleteModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <!-- Modal content -->
                                        <form action="/admin/konfirmasi/{{ $data->id }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <div
                                ...
                                <!-- Read modal -->
                                <div id="readKonfirmasiModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-xl max-h-full">
                                        ...
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            ...
                                            <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                                                <div class="text-lg text-gray-900 md:text-xl dark:text-white">
                                                    <h3 class="font-semibold ">
                                                        {{ $data->user->name }}
                                                        @if ($data->status)
                                                            <svg class="float-end ml-3 w-6 h-6 text-green-800 dark:bg-gray-300 dark:rounded-full dark:text-green-800 dark:border-gray-600"
                                                        ...
                                                        @else
                                                            <svg class="float-end ml-3 w-6 h-6 text-yellow-800 dark:bg-gray-300 dark:rounded-full dark:text-yellow-800"
                                                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" fill="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path fill-rule="evenodd"
                                                    ...
                                                    <p class="font-bold">ID: {{ $data->user_id }}</p>
                                                </div>
                                                <div>
                                                    <button type="button"
                                            ...
                                            <dl>
                                                ...
                                                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                                    Rp. {{ Number::format($data->nominal, 0, 0, 'id-ID') }}
                                                </dd>
                                                <dt
                                                    class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                    Tanggal
                                                ...
                                                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                                    <img src="{{ asset('storage/' . $data->bukti_transfer) }}"
                                                        alt="bukti Transfer">
                                                    {{-- {{ url('/') }}
                                                    {{ $data->bukti_transfer }} --}}
                                                    {{-- Gambar --}}
