                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-end">{{ Number::format($data->penyedia_paket) }}</td>
                                    <td class="px-4 py-3 text-end">{{ Number::format($data->penyedia_pagu) }}</td>
                                    <td class="px-4 py-3 text-end">{{ Number::format($data->swakelola_paket) }}</td>
                                    <td class="px-4 py-3 text-end">{{ Number::format($data->swakelola_pagu) }}</td>
                                    <td class="px-4 py-3 text-end">
                                        {{ Number::format($data->penyedia_dalam_swakelola_paket) }}</td>
                                    <td class="px-4 py-3 text-end">
