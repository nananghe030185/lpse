<x-backend.layout>
    ...
    <x-slot name="header">
        <x-breadcrumb href="{{ route('user.index') }}">Users</x-breadcrumb>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" method="post" action="{{ route('user.index') }}">
                            @csrf
                            @method('get')
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $data->groups->name }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="apple-imac-{{ $data->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="readUserModal{{ $data->id }}"
                                                        data-modal-toggle="readUserModal{{ $data->id }}"
                                                        class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                        <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                            viewbox="0 0 20 20" fill="currentColor"
                                                            aria-hidden="true">
                                        ...
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            ...
                                            <form action="/admin/users/{{ $data->id }}" method="post">
                                                ...
                                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                    ...
                                                    <div>
                                                        <label for="username"
                                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('user.username') }}</label>
                                                    ...
                                                    <div>
                                                        <label for="group"
                                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('user.group') }}</label>
                                                        <select id="group" name="group_id"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                            @foreach ($groups as $group)
                                                                <option value="{{ $group->id }}"
                                                                    @if ($data->groups->id == $group->id) selected @endif>
                                                                    {{ $group->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div>
                                                        <label class="inline-flex items-center cursor-pointer">
                                                            <span
                                                                class="mr-3 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('user.state') }}</span>
                                ...
                                <!-- Read modal -->
                                <div id="readUserModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        ...
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            ...
                                            <dl>
                                                ...
                                                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                                    ...
                                                    10th-generation Intel Core i7 processor, Turbo Boost up to 5.0GHz,
                                                    16GB 2666MHz DDR4 memory,
                                                    Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD storage,
                                                    Gigabit Ethernet, Magic Mouse 2,
                ...
                <form action="/admin/users" method="post">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="username" id="username"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="{{ __('user.username') }}" required="">
                        </div>
                        <div>
                            <label for="email"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('user.email') }}</label>
                        ...
                        <div>
                            <label for="password"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('user.password') }}</label>
