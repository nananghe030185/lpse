                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 sm:w-15">Nama Paket</th>
                                <th scope="col" class="px-4 py-3 w-15">HPS</th>
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 hover:text-blue-800">
                                        <a href="{{ $data->datalpse->link }}/lelang/{{ $data->kd_tender }}/pengumumanlelang"
                                            target="_blank">
                                            {{ $data->nama_paket }}
                                            <span
                                            ...
                                            <span
                                                class="bg-{{ $data->status_tender == 'Aktif' ? 'green' : 'red' }}-100 text-{{ $data->status_tender == 'Aktif' ? 'green' : 'red' }}-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-{{ $data->status_tender == 'Aktif' ? 'green' : 'red' }}-900 dark:text-{{ $data->status_tender == 'Aktif' ? 'green' : 'red' }}-300">{{ $data->status_tender }}</span>
                                        </a>
                                    </td>
                                    <td class="px-4 py-3 text-end block">
