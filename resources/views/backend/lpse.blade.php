                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Kode LPSE</th>
                            ...
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        ...
                                        {{ $data->id }}</th>
                                    <td class="px-4 py-3">{{ $data->kd_lpse }}</td>
                                    <td class="px-4 py-3">{{ $data->nama_lpse }}</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">{{ $data->jumlah_paket }}</td>
                                    <td class="px-4 py-3">{{ $data->jumlah_pagu }}</td>
