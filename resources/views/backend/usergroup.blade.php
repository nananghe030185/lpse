<x-backend.layout>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" method="post" action="{{ route('usergroup.index') }}">
                            @csrf
                            @method('get')
                    ...
                    <div
                        ...
                        <button type="button" id="createUserGroupModalButton" data-modal-target="createUserGroupModal"
                            data-modal-toggle="createUserGroupModal"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="apple-imac-{{ $data->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="updateUserGroupModal{{ $data->id }}"
                                                        data-modal-toggle="updateUserGroupModal{{ $data->id }}"
                                ...
                                <!-- Update modal -->
                                <div id="updateUserGroupModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            ...
                                            <!-- Modal body -->
                                            <form action="/admin/usergroup/{{ $data->id }}" method="post">
                                                @csrf
                                                @method('put')
                                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                    <div>
                                                        <label for="name"
                                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('usergroup.name') }}</label>
                                                        <input type="text" name="name" id="name"
                                                            value="{{ $data->name }}"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                            placeholder="{{ __('usergroup.name') }}">
                                                    </div>
    ...
    <!-- End block -->
    <!-- Create modal -->
    <div id="createUserGroupModal" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <!-- Modal content -->
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-target="createUserGroupModal" data-modal-toggle="createUserGroupModal">
                ...
                <!-- Modal body -->
                <form action="/admin/usergroup" method="post">
                    @csrf
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="{{ __('usergroup.name') }}" required="" autofocus>
                        </div>
                    </div>
                    <button type="submit"
