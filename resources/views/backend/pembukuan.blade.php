<x-backend.layout>
    ...
    <x-slot name="header">
        <x-breadcrumb href="{{ route('pembukuan.index') }}">Laporan Pembukuan</x-breadcrumb>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="{{ route('pembukuan.index') }}" method="post">
                            @csrf
                            @method('get')
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Pemasukan</th>
                            ...
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-end">
                                        Rp. {{ Number::format($data->pemasukan, 0, 0, 'id-ID') }}
                                    </td>
                                    <td class="px-4 py-3 text-end">
                                        Rp. {{ Number::format($data->pengeluaran, 0, 0, 'id-ID') }}
                                    </td>
                        ...
                        <tfoot>
                            <tr class="font-semibold text-gray-900 dark:text-white">
                                <th scope="row" colspan="4" class="px-6 py-3 text-base text-end">Total</th>
                                <td class="px-6 py-3 text-end">Rp. {{ Number::format($pemasukan, 0, 0, 'id-ID') }}
                                </td>
                                <td class="px-6 py-3 text-end">Rp. {{ Number::format($pengeluaran, 0, 0, 'id-ID') }}
                                </td>
                                <td class="px-6 py-3 text-end">Rp. {{ Number::format($saldo, 0, 0, 'id-ID') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
