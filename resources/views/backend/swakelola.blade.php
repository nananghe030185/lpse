<x-backend.layout>
    ...
    <x-slot name="header">
        <x-breadcrumb href="{{ route('swakelola.index') }}">Swakelola</x-breadcrumb>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex w-full flex-col md:flex-row gap-2 px-2 py-2 mx-2">
                    <div class="w-full md:w-8/12">
                        {{-- Input Search --}}
                        <form action="{{ route('swakelola.index') }}" method="POST">
                            @csrf
                            @method('get')
                    ...
                    <div class="w-full md:w-4/12 flex md:justify-end">
                        <div
                            ...
                            @can('admin')
                                <form action="/api/swakelola" method="post">
                                    @csrf
                                    <button type="submit"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="apple-imac-{{ $data->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <form action="/admin/swakelola" method="post">
                                                        @csrf
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="readSwakelolaModal{{ $data->id }}"
                                                        data-modal-toggle="readSwakelolaModal{{ $data->id }}"
                                                        class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                ...
                                <!-- Read modal -->
                                <div id="readSwakelolaModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
