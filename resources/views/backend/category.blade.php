<x-backend.layout>
    ...
    <x-slot name="header">
        <x-breadcrumb href="{{ route('category.index') }}">Category</x-breadcrumb>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="{{ route('category.index') }}" method="post">
                            @csrf
                            @method('get')
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div id="filterDropdown"
                                ...
                                <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                    <li class="flex items-center">
                                        <input id="kementrian" type="checkbox" value="Kementrian"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="kementrian"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Kementrian</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="lembaga" type="checkbox" value="Lembaga"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="lembaga"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Lembaga</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="provinsi" type="checkbox" value="Provinsi"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="provinsi"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Provinsi</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="kota" type="checkbox" value="Kota"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="kota"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Kota</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="kabupaten" type="checkbox" value="Kabupaten"
                                            class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="kabupaten"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Kabupaten</label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch"
                                ...
                                type="button">Dropdown search <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                            ...
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row"
                                        ...
                                        {{ $data->id }}</th>
                                    <td class="px-4 py-3">{{ $data->name }} <br> {{ $data->slug }}</td>
                                    {{-- <td class="px-4 py-3">{{ $data->cat->name }}</td> --}}
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" id="slug"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="{{ __('category.slug') }}" required="">

                            </div>

                            <div class="sm:col-span-2">
                                <label for="description"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('category.description') }}</label>
                                <textarea id="description" rows="4" name="description"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="{{ __('category.description') }}" required=""></textarea>
                            </div>
