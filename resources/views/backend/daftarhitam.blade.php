<x-backend.layout>
    ...
    <x-slot name="header">
        <x-breadcrumb href="{{ route('daftarhitam.index') }}">Daftar Hitam</x-breadcrumb>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/3">
                        <form class="flex items-center" action="{{ route('daftarhitam.index') }}">
                    ...
                    <div
                        ...
                        @can('admin')
                            <div
                                class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 md:items-center justify-end md:space-x-3 flex-shrink-0 ">
                                <form action="/api/daftarhitam" method="post">
                                    @csrf
                                    <button type="submit"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-4">Tahun Anggaran</th>
                                <th scope="col" class="px-4 py-3">Nama KLPD</th>
                                <th scope="col" class="px-4 py-3">Nama Satker</th>
                                <th scope="col" class="px-4 py-3">Nama Penyedia</th>
                                <th scope="col" class="px-4 py-3">Alamat penyedia</th>
                            ...
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        ...
                                        {{ $data->id }}</th>
                                    <td class="px-4 py-3">{{ $data->tahun_anggaran }}</td>
                                    <td class="px-4 py-3">{{ $data->nama_klpd }}</td>
                                    <td class="px-4 py-3">{{ $data->nama_satker }}</td>
                                    <td class="px-4 py-3">{{ $data->nama_penyedia }}</td>
                                    <td class="px-4 py-3">
                                        {{ $data->alamat_penyedia . ',' . $data->kabupaten_penyedia . ',' . $data->provinsi_penyedia }}
                                    </td>
                                    <td class="px-4 py-3">
                                        {{ Carbon\Carbon::parse($data->tgl_berlaku_sampai)->format('d M Y') }}
                                    </td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="apple-imac-{{ $data->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="readDaftarHitamModal{{ $data->id }}"
                                                        data-modal-toggle="readDaftarHitamModal{{ $data->id }}"
                                ...
                                <!-- Read modal -->
                                <div id="readDaftarHitamModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            <!-- Modal header -->
                                            <div
                                                class="flex justify-between items-center pb-4 mb-4 rounded-t sm:mb-5 dark:border-gray-600 border-b">
                                            ...
                                            <div class="grid gap-4 mb-4 sm:grid-cols-2 overflow-y-scroll h-96">
                                                <div>
                                                    <label
                                                        ...
                                                        {{ __('daftarhitam.alamat_penyedia') }} :
                                                    </label>
                                                ...
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.no_sk_blacklist') }} :
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                        {{ $data->no_sk_blacklist }}
                                                    </div>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.tgl_tayang_blacklist') }} :
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                        {{ $data->tgl_tayang_blacklist }}
                                                    </div>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.tgl_berlaku_dari') }}:
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                ...
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.tgl_berlaku_sampai') }}:
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                ...
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.jenis_pelanggaran') }}:
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                ...
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.deskripsi_pelanggaran') }}:
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                ...
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.no_sk_pencabutan') }}:
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                        {{ $data->no_sk_pencabutan }}
                                                    </div>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block mb-2 font-semibold leading-none text-gray-900 dark:text-white">
                                                        {{ __('daftarhitam.tgl_sk_pencabutan') }}:
                                                    </label>
                                                    <div class="dark:text-slate-100">
                                                        {{ $data->tgl_sk_pencabutan }}
                                                    </div>
                                                </div>
                                ...
                                <div id="deleteModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <!-- Modal content -->
                                        <form action="/admin/daftarhitam/{{ $data->id }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <div
