            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" action="{{ route('post.index') }}" method="post">
                            @csrf
                            @method('get')
                    ...
                    <form action="/admin/post/create" method="get">
                        @csrf
                        <button type="submit">
                            Ok
                        </button>
                    ...
                    <div
                        ...
                        <button type="button" id="createProductModalButton" data-modal-target="createPostModal"
                            ...
                            @foreach ($datas as $data)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row"
                                        ...
                                        {{ $data->id }}</th>
                                    <td class="px-4 py-3">{{ $data->title }} <br> {{ $data->slug }}</td>
                                    <td class="px-4 py-3">{{ $data->cat->name }}</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        {{ Str::limit($data->description, 100) }}</td>
                                ...
                                <div id="updateProductModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                            ...
                                            <!-- Modal body -->
                                            <form action="/admin/post/{{ $data->id }}" method="post">
                                                @csrf
                                                @method('put')
                                                    ...
                                                    <div>
                                                        ...
                                                        <select id="cat_id" name="cat_id"
                                                            ...
                                                            @foreach ($categories as $id => $cat)
                                                                <option value="{{ $cat->id }}"
                                                                    @if ($cat->id == $data->cat_id) @selected(true) @endif>
                                                                    {{ $cat->name }}</option>
                                                            @endforeach
                                    ...
                                    placeholder="Tulis Artikel di sini" required=""></textarea> --}}
                                ...
                                <div id="readProductModal{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-2xl max-h-full dark:bg-gray-700 rounded-lg">
                                        <!-- Modal content -->
                                        <div
                                            class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                                            <!-- Modal header -->
                                        ...
                                        <div class="grid gap-4 mb-4">
                                            <div class="dark:text-gray-200 overflow-y-scroll">
                                                {!! $data->body !!}
                                            </div>
                                        </div>
