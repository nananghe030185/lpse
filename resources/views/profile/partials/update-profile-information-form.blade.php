    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text"
                class="mt-1 block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" :value="old('name', $user->name)"
        ...
        <div>
            ...
            <x-text-input id="username" name="username" type="text"
                class="mt-1 block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" :value="old('username', $user->username)"
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="text"
                class="mt-1 block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" :value="old('email', $user->email)"
